...
public class InactiveUserFragment extends Fragment {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            userView.setOnClickListener(v -> {
                                Fragment userDetailFragment = new InactiveUserDetailsFragment();
                                ...
                                // Hide this fragment
                                transaction.hide(InactiveUserFragment.this);
