...
public class InactiveUserDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_inactive_user_details, container, false);
        ...
        activeButton.setOnClickListener(v -> {
            ...
            userRef.update("status", "active").addOnSuccessListener(aVoid -> {
