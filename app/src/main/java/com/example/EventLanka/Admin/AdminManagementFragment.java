...
import androidx.fragment.app.FragmentTransaction; // import for hide(), add(), etc.
...
public class AdminManagementFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppCompatButton inactiveButton = view.findViewById(R.id.inactive_button);
        inactiveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment inactiveUserFragment = new AddAdminFragment();
                FragmentTransaction transaction = requireActivity()
                        .getSupportFragmentManager()
                        .beginTransaction();

                // Hide this fragment
                transaction.hide(AdminManagementFragment.this);
                ...
                transaction.add(R.id.mainScrillView, inactiveUserFragment);
        ...
        LinearLayout view1 = view.findViewById(R.id.loadAdmin);
        ...
        firestore.collection("user")
                ...
                .where(Filter.equalTo("type", "admin"))
                .get()
    ...
    public void loadUser() {
        // Reload users (Refetch data from Firestore)
        getActivity().getSupportFragmentManager().beginTransaction()
                .detach(this) // Remove fragment from UI
                .attach(this) // Re-attach it (causes refresh)
                .commit();
    }
